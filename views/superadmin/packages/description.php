...
$this->breadcrumbs=array(
    ...
    'Просмотр' => array('description', 'name' => $package['info']['name'], 'version' => $package['info']['version']),
);
?>
...
<table>
    ...
    <tr>
        ...
        <td>
            <?php if (array_keys_exists(array('database', 'import'), $package) && is_array($package['database']['import'])) : ?>
            <ul>
    ...
    <tr>
        ...
        <td>
            <table>
                ...
                <?php if (isset($package['updates']) && is_array($package['updates'])) : ?>
                <?php foreach($package['updates'] as $update) : ?>
                <tr>
                    <td><?=CHtml::encode($update['version'])?></td>
                    <td>
                        <?php if (is_array($update) && array_keys_exists(array('database', 'import'), $update) && is_array($update['database']['import'])) : ?>
                        <ul>

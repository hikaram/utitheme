...
$this->breadcrumbs=array(
	...
	'Новые' => array('new'),
    'Просмотр нового модуля' => array('newfullinfo', 'version' => $application['info']['version']),
);
?>
    ...
    <tr>
        ...
        <td>
            <table>
                ...
                <?php if (array_keys_exists(array('relations', 'modules'), $application) && is_array($application['relations']['modules'])) : ?>

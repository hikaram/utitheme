...
<table class="from_register" style='width: 570px; padding: 0;'>
    ...
    <? if ((array_key_exists('password', $list)) && ((bool)$list['password']->is_user_filltype)): ?>
		...
		<? elseif (($list['password']->param != NULL) && ($list['password']->param->show_type == UsersRegisterFieldsParams::SHOW_TYPE_DYNAMIC)) : ?>
			...
			<tr id="passwordsFields_password">
				<td><?=$form->passwordField($model, 'password', array('size' => 20,'maxlength' => 20, 'class' => 'forminput', 'name' => 'Users[password_w]', 'id' => 'Users_password_w', 'title' => Yii::t('app', 'Данное поле должно содержать только латинские символы (a-z), цифры (0-9), знак подчеркивания, точка. Буквы в верхнем и в нижнем регистре являются разными символами. Минимальная длина данного поля должна быть 6 символов'))); ?></td>
				<td><?=$form->passwordField($model, 'password_confirm', array('size'=>20,'maxlength'=>20, 'class' => 'forminput', 'name' => 'Users[password_confirm_w]', 'id' => 'Users_password_confirm_w', 'title' => Yii::t('app', 'Данное поле должно содержать только латинские символы (a-z), цифры (0-9), знак подчеркивания, точка. Буквы в верхнем и в нижнем регистре являются разными символами. Минимальная длина данного поля должна быть 6 символов'))); ?></td>
				<td>
			...
			<tr id="passwordShow_password" style="display: none;">
				<td><?=$form->labelEx($model, 'password')?></td>
				<td><?=$form->textField($model, 'password', array('size' => 60,'maxlength' => 100, 'class' => 'forminput', 'name' => 'Users[password_n]', 'id' => 'Users_password_n', 'title' => Yii::t('app', 'Данное поле должно содержать только латинские символы (a-z), цифры (0-9), знак подчеркивания, точка. Буквы в верхнем и в нижнем регистре являются разными символами. Минимальная длина данного поля должна быть 6 символов')))?></td>
	...
	<? if((array_key_exists('series_passport', $list)) && ((bool)$list['series_passport']->is_user_filltype)): ?>
		<tr>
            <td><?=$form->labelEx($profile,'series_passport'); ?></td>
            <td><?=$form->textField($profile,'series_passport', array('class' => 'forminput')); ?></td>
			<td></td>
        </tr>
		<tr><td colspan="3" id="series_passporterror" style="color: red;"><?=$form->error($profile,'series_passport'); ?></td></tr>
	<? endif?>   

                ...
                <?php $form=$this->beginWidget('CActiveForm', array('enableAjaxValidation'=>false)); ?>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li style="padding: 22px 0;">
                            <span style =" float: left;  padding: 1px 28px 10px; background: url(<?=$url?>/yandexmoney_logo.png) no-repeat;">&nbsp;</span> 
                            <span class="sale-info" style="font-size: 11px;">
                                <?=Yii::t('app', 'Введите номер телефона на который зарегистрирован кошелек YandexMoney.')?>
                            </span>
                            <br /><br />
                            <span class="sale-num">

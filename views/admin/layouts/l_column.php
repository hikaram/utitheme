...
<link href="<?=Yii::app()->params['hostMetronikStatic']?>/public/assets/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<!-- END THEME STYLES -->
<link rel="shortcut icon" href="<?=Yii::app()->theme->baseUrl?>/public/admin/images/favicon.ico"/>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="http://uticms.com" class="logo-wrap">
				<img src="<?=Yii::app()->params['hostMetronikStatic']?>/public/assets/admin/layout/img/uticms-logo.png" alt="logo" class="logo-default"/>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					<a href="#" class="dropdown-toggle" style="height: 46px;" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <? /* if (!Yii::app()->user->isGuest) : ?>
                            <? $photo = Attachments::model()->find('object_alias=:object_alias AND object_id=:object_id', array(':object_alias' => 'profile', ':object_id' => Yii::app()->user->id));?>
                            <? if (($photo != NULL) && ($photo->secret_name != null)) : ?>
                                <?= CHtml::image(MSmarty::attachment_get_file_name($photo->secret_name, $photo->raw_name, $photo->file_ext, '_office_profile', 'office_photo'), '', array('class' => 'img-circle')); ?>
                            <? else : ?>
                                <?= CHtml::image(Yii::app()->assetManager->getPublishedUrl(Yii::getPathOfAlias('office.modules.profile.css')) . '/img/o.jpg', 'nophoto', array('class' => 'img-circle')); ?>
                            <? endif; ?>
                        <? endif; */?>
						<?//Если будете вставлять фото пользователя, то учтите и код для superadmin, он фото не будет загружать. ?>
					...
					<ul class="dropdown-menu">
                        ...
                        <? endif; ?>
                        <? if (Yii::app()->isModuleInstall('Office')) : ?>
                            <li>
                                <a href="/office">
                        ...
                        <? endif; ?>
						<? if (((bool)ALLOW_OFFSET_DB_DATE) && ((YII_DEBUG) || (Yii::app()->user->username == Yii::app()->params['superAdminInfo']['username']))) : ?>
                            <li>
                                <a href="/admin/default/timesettings">
						...
						<li>
							<a href="<?=$this->createUrl('/superadmin');?>">
...
<div class="page-container">
	...
	<div class="page-sidebar-wrapper">
		...
		<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<?php $this->widget('NavigationWidget', array(
					'alias' => 'admin_main_navigation',
					'template' => 'admin_level_1'
				));?> 
	...
	<div class="page-content-wrapper">
		<div class="page-content">
				...
				<div class="col-md-12">
					...
					<?php if(isset($this->breadcrumbs)):?>
							<?php $this->widget('zii.widgets.CBreadcrumbs', array(
								...
								'homeLink' => '<li><i class="fa fa-home"></i>' . CHtml::link(Yii::t('superadmin','Главная'), Yii::app()->homeUrl) . '</li>',
							)); ?><!-- breadcrumbs -->
					<?php endif?>
            ...
            <?php $this->widget('UTIAdminFlashMessagesWidget'); ?>            

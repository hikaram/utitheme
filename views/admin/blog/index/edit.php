...
$this->breadcrumbs = array(
	...
	Yii::t('app', 'Редактирование статьи блога') . ' #' . $post->id => array($this->createUrl('edit', array('post' => $post->id))),
	);
	?>
	<?php
	...
	<div class="portlet green box">	
		<div class="portlet-title">
			<div class="caption" style='margin: 10px; display: block; float: none;'>
                <i class="glyphicon glyphicon-plus"></i> <h4><?=Yii::t('app','Редактирование статьи блога')?></h4>
            </div>
		</div>
...
<div class="form-actions">
	<?=CHtml::submitButton(Yii::t('app', 'Изменить'), array ('class' => 'btn green', 'name' => 'btn_edit')); ?>

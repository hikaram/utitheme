	...
	<div class="panel-body form" style="display: none;" id="content_filter">
		...
		<?php $form = $this->beginWidget('CActiveForm', array(
			...
			<div class="form-body">
				...
				<div class="row">
					<div class="col-md-6">
						<h4 class="form-section"> <?=Yii::t('app', 'Название страницы')?></h4>
					...
					<div class="col-md-6">
						<h4 class="form-section"> <?=Yii::t('app', 'Описание')?></h4>
						<div class="form-group" style="margin-left: 0; margin-right: 0;">
							<?=CHtml::textField('description', array_key_exists('description', $filter) ? $filter['description'] : (string)FALSE, ['class' => 'form-control input-inline input-large'])?>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<h4 class="form-section"><?=Yii::t('app', 'Дата создания страницы')?></h4>
			...
			<div class="form-actions">
				...
				<?php echo CHtml::button(Yii::t('app', 'Сбросить'), array('name'=>'btn_cancel', 'class' => 'btn red', 'onClick' => 'location.href="' . substr($this->createUrl('/admin/page/lite/index'), 0, strpos($this->createUrl('/admin/page/lite/index'), '/subsession/')) . '"')); ?>
			</div>
		<?php $this->endWidget(); ?>
	</div>
</div>

...
<table class="form">
    <tbody>
        ...
        <tr>
                ...
                <input type="text" value="<?php echo isset($model->parent_id) ? UploadsCategories::GetName($model->parent_id) : ''?>" readonly="readonly" id="cat_text" style="width: 250px;">
        ...
        <tr>
                <td width="180" style="padding-top: 10px;"><?=CHtml::activeLabelEx($model_lang,'description'); ?></td>
                <td colspan="2">
                    <? $ckeditorconfig = array('name' => 'UploadsCategoriesLang[description]', 'type' => 'small', 'ckfinder' => FALSE, 'value' => $model_lang->description, 'height' => '150'); ?> 
        ...
        <tr>
            <td width="180" style="padding-top: 10px;"><?=CHtml::activeLabelEx($model,'banner'); ?></td>
            <td colspan="2">
            <p>Учитывайте, пользователи увидят данный блок с фиксированной шириной 715</p>
            <?=FSmarty::ckeditor(array('name' => 'UploadsCategories[banner]', 'type' => 'content', 'ckfinder' => true, 'value' => $model->banner, 'width' => 715)) ?></td>
        </tr>

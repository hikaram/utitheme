...
<div class="note note-success">
	Типы статусов еще не созданы. Вы можете <a href="<?=$this->createUrl('create')?>">создать</a> сейчас.
</div>
<?php else : ?>
<div class="portlet box yellow">
	<div class="portlet-title">
		<h3 class="caption"><i class="fa fa-refresh"></i> Статусы кошельков</h3>
	</div>
						...
						<td>
							...
							<?=CHtml::form('', 'post', array('class'=>'btn', 'style'=>'padding: 0;'))?>
								<?=CHtml::linkButton('<button class="btn red"><i class="glyphicon glyphicon-remove"></i></button>', array(
									...
									'confirm'=>"Удалить данный статус операции? Данное действие может привести к невозможности выполнять финаносовые операции."
								))?>
							<?=CHtml::endForm() ?>            
						</td>
					</tr>
...
<a href="<?=$this->createUrl('create')?>">Создать новый статус операции.</a>
<?php endif; ?>
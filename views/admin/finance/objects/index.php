...
<div class="note note-success">
	Объекты еще не созданы. Вы можете <a href="<?=$this->createUrl('create')?>">создать</a> сейчас.
</div>
<?php else : ?>
<div class="portlet box yellow">
	<div class="portlet-title">
		<h3 class="caption"><i class="fa fa-puzzle-piece"></i> Объекты</h3>
	</div>
...
<a href="<?=$this->createUrl('create')?>">Создать новый объект</a>
<?php endif; ?>
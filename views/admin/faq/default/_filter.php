	...
	<div class="panel-body form" style="display: none;" id="content_filter">
		...
		<?php $form = $this->beginWidget('CActiveForm', array(
			...
			<div class="form-body">
				...
				<div class="row">
					<div class="col-md-6">
						<h4 class="form-section"> <?=Yii::t('app', 'Поиск по тексту в вопросе')?></h4>
						<div class="form-group" style="margin-left: 0; margin-right: 0;">
							<?=CHtml::textField('question_text', array_key_exists('question_text', $filter) ? $filter['question_text'] : (string)FALSE, ['class' => 'form-control input-inline input-large'])?>
						</div>
					</div>
					<div class="col-md-6">
						<h4 class="form-section"><?=Yii::t('app', 'Дата создания вопроса')?></h4>
			...
			<div class="form-actions">
				...
				<?php echo CHtml::button(Yii::t('app', 'Сбросить'), array('name'=>'btn_cancel', 'class' => 'btn red', 'onClick' => 'location.href="' . substr($this->createUrl('/admin/faq/default/index'), 0, strpos($this->createUrl('/admin/faq/default/index'), '/subsession/')) . '"')); ?>
			</div>
		<?php $this->endWidget(); ?>
	</div>
</div>

        ...
        <div id="tabs-1">
			...
			<div class="inbox-content">
				...
				<div class="inbox-header inbox-view-header">
					<h1 class="pull-left">
						<?= CHtml::encode($result[0]['title']) ?> <a href="<?=Yii::app()->createUrl('/office/message/outbox')?>"><?=Yii::t('app', 'Отправленные')?> </a>
					</h1>
				...
				<div class="inbox-view-info">
					<div class="row">
						...
						<div class="col-md-5 inbox-info-btn">
							<div class="btn-group">
								<button class="btn blue reply-btn" onClick="window.location = app.createAbsoluteUrl('office/message/default/create/messageId/<?=$result[0]["id"]?>')"><i class="fa fa-reply"></i> <?=Yii::t('app', 'Переслать')?> </button>

...
<? if (!$empty) : ?>
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-table"></i>Первая линия
            </div>
        </div>
                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body" style="padding-left: 30px;">
                        <div class="filter-block" style="/*overflow: hidden;*/ display: block; width: 90%;">
                                    ...
                                    <? if ((bool)$field['is_filter']) : ?>
                                        <tr>
                                            ...
                                            <td style="/*padding-left: 17px; padding-right: 25px;*/">
                                                ...
                                                <? else : ?>
                                                    <?=CHtml::textField($field['alias'], array_key_exists($field['alias'], $filter) ? $filter[$field['alias']] : '', array('style'=>'width: 99%','class' => 'form-control form-input'))?>
                                                <? endif; ?>
                                            </td>
                                        </tr>
                                    <? endif; ?>
                            ...
                            <div class="row">
                                <div class="col-6" >
                                    <?=CHtml::button(Yii::t('app', 'Фильтровать'), array('class' => 'btn green', 'onClick' => 'saveFilter("firstline")'))?>
                                    <!--                                      </div>
                                                                          <div class="col-6">-->
                                    <?=CHtml::button(Yii::t('app', 'Сбросить фильтр'),  array('class' => 'btn green','onClick' => 'location.href="/office/statssync/default/firstline"'))?>
                                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <? if (empty($list)) : ?>
                        ...
                        <? else : ?>
                            <div style="margin: 15px;"><?=Yii::t('app', 'Не найдено ни одного пользователя, удовлетворяющего условиям фильтрации')?></div>
                        <? endif; ?>
                    <? else : ?>
                        <h3 class="text-center bold mb50">Всего в структуре пользователей: <?=$count?></h3>
                        <div style="overflow: auto; padding-left: 15px;">
                            <?php $cities = $this->beginWidget('CitiesWidget', array()); ?>
                            <table class="table table-striped table-hover table-bordered dataTable no-footer" style="width: 99%;">
                    ...
                    <div style="margin: 15px 0 15px 10px;">
                        <?=CHtml::beginForm($this->createUrl('index'))?>

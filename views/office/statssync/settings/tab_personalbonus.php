...
<div class="report-wrapper">
    ...
    <?=CHtml::link(Yii::t('app', 'Перейти к отчету'), $this->createUrl('default/personalbonusbyperiods'))?>
        ...
        <div class="portlet-body">
            <div id="bootstrap_alerts_demo">
                <div class="param-report">
                    ...
                    <?=CHtml::beginForm($this->createUrl('settings/saveform/alias/' . SettingsControllerBase::ReportAliasPersonalbonus))?>
...
-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <?=CHtml::checkBox('is_filter_' . SettingsControllerBase::ReportAliasPersonalbonus, $params->is_filter, array('onClick' => 'changeFilter("' . SettingsControllerBase::ReportAliasPersonalbonus . '")'))?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <?=CHtml::submitButton(Yii::t('app', 'Сохранить'), array('class' => 'btn green btn-lg', 'name' => 'btn-' . SettingsControllerBase::ReportAliasPersonalbonus . '-save'))?>
                                <!--<td colspan="2"><?/*=CHtml::submitButton(Yii::t('app', 'Сохранить'), array('class' => 'btn100', 'name' => 'btn-' . SettingsControllerBase::ReportAliasPersonalbonus . '-save'))*/?></td>-->
                            </div>
                        </div>
                    </div>
    ...
    <div class="report-table-<?=SettingsControllerBase::ReportAliasPersonalbonus?>">

        <?=$this->renderPartial('tablecolumns', array(
            'config' => $config,
            'alias' => SettingsControllerBase::ReportAliasPersonalbonus,
            'min_sort' => $min_sort,
            'max_sort' => $max_sort,
    ...
    <div class="report-manage">
        ...
        <div class="report-manage-dynamic">
            ...
            <div class="listBox">
                ...
                <?=CHtml::listBox(SettingsControllerBase::ReportAliasPersonalbonus, 0,  $allColumns, array('size' => 0, 'class' => 'form-control input-small input-inline'))?>

                <?=CHtml::button('Добавить поле', array('class' => 'btn green', 'onClick' => 'addColumn("' . SettingsControllerBase::ReportAliasPersonalbonus . '")'))?>

...
<?=CHtml::link(Yii::t('app', 'Перейти к отчету'), $this->createUrl('default/birthday'))?>
        ...
        <div class="portlet-body">
            <div id="bootstrap_alerts_demo">
                <div class="param-report">
                    ...
                    <?=CHtml::beginForm($this->createUrl('settings/saveform/alias/' . SettingsControllerBase::ReportAliasBirthday ))?>
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="title"><?=CHtml::activeLabel($params, 'dlevel')?></label>
                            <div class="col-md-7">
                                <?=CHtml::activeTextField($params, 'dlevel', array('class' => "form-control"))?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <?=CHtml::checkBox('is_filter_' . SettingsControllerBase::ReportAliasBirthday , $params->is_filter, array('onClick' => 'changeFilter("' .SettingsControllerBase::ReportAliasBirthday  . '")'))?>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-3 control-label" for="title"><?=CHtml::activeLabel($params, 'datefilter_type')?></label>
                            <div class="col-md-7">
                                <?=CHtml::activeRadioButtonList($params, 'datefilter_type', array(OfficeStatsReportsParams::dateFilterTypeBetween => Yii::t('app', 'Фильтровать в интервале двух дат'), OfficeStatsReportsParams::dateFilterTypeMonthSelect => Yii::t('app', 'Фильтровать выбором конкретного месяца')))?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <?=CHtml::submitButton(Yii::t('app', 'Сохранить'), array('class' => 'btn green btn-lg', 'name' => 'btn-' . SettingsControllerBase::ReportAliasBirthday . '-save'))?>
    ...
    <div class="report-table-<?=SettingsControllerBase::ReportAliasBirthday?>">

        <?=$this->renderPartial('tablecolumns', array(
            'config' => $config,
            'alias' => SettingsControllerBase::ReportAliasBirthday,
            'min_sort' => $min_sort,
            'max_sort' => $max_sort,
    ...
    <div class="report-manage">
        ...
        <div class="report-manage-dynamic">
            ...
            <div class="listBox">
                ...
                <?=CHtml::listBox(SettingsControllerBase::ReportAliasBirthday, 0,  $allColumns, array('size' => 0, 'class' => 'form-control input-small input-inline'))?>

                <?=CHtml::button('Добавить поле', array('class' => 'btn green', 'onClick' => 'addColumn("' . SettingsControllerBase::ReportAliasBirthday . '")'))?>

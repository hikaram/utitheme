...
<?=CHtml::link(Yii::t('app', 'Перейти к отчету'), $this->createUrl('default/tree'))?>
        ...
        <div class="portlet-body">
            <div id="bootstrap_alerts_demo">
                <div class="param-report">
                    ...
                    <?=CHtml::beginForm($this->createUrl('settings/saveform/alias/' .SettingsControllerBase::ReportAliasTree))?>
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="title"><?=CHtml::activeLabel($params, 'contacts_level')?></label>
                            <div class="col-md-7">
                                <?=CHtml::activeTextField($params, 'contacts_level', array('class' => "form-control"))?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <?=CHtml::checkBox('is_filter_' . SettingsControllerBase::ReportAliasTree, $params->is_filter, array('onClick' => 'changeFilter("' . SettingsControllerBase::ReportAliasTree . '")'))?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <?=CHtml::submitButton(Yii::t('app', 'Сохранить'), array('class' => 'btn green btn-lg', 'name' => 'btn-' . SettingsControllerBase::ReportAliasTree . '-save'))?>
    ...
    <div class="report-table-<?=SettingsControllerBase::ReportAliasTree?>">

        <?=$this->renderPartial('tablecolumns', array(
            'config' => $config,
            'alias' => SettingsControllerBase::ReportAliasTree,
            'min_sort' => $min_sort,
            'max_sort' => $max_sort,
    ...
    <div class="report-manage">
        ...
        <div class="report-manage-dynamic">
            ...
            <div class="listBox">
                ...
                <?=CHtml::listBox(SettingsControllerBase::ReportAliasTree, 0,  $allColumns, array('size' => 0, 'class' => 'form-control input-small input-inline'))?>

                <?=CHtml::button('Добавить поле', array('class' => 'btn green', 'onClick' => 'addColumn("' . SettingsControllerBase::ReportAliasTree . '")'))?>

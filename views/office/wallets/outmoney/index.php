...
<div class="portlet box green">
    ...
    <div class="portlet-body form-horizontal form form-bordered">
		<?php $form = $this->beginWidget('CActiveForm', array('action' => $this->createUrl('outmoney/outtouser/wallet/' . $wallet->id), 'htmlOptions' => array('class' => ''))); ?>
		<div class="form-body">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<div class="input-group">
						...
						<input type="text" name="Form[login_to_user]" class="form-control" value="" />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<div class="input-group">
						...
						<input type="text" name="Form[transfer_amount]" class="form-control tt-hint" value="" />
					</div>
				</div>
			</div>
...
<? if ((bool)$accessToWalletOut) : ?>
    ...
    'scenario' => 'debit',
    'pageTitle' => Yii::t('app', 'Вывод денег'),
    'is_show_objects'=>TRUE,
    'buttonCaption' => Yii::t('app', 'Вывести'),
    ...
    {
        $finance->modelFinance->setSpecificationByAlias($this->getAliasForOperation('wallet_out'));
    }
    else
    {
        $finance->modelFinance->setSpecificationByAlias($this->getAliasForOperation('wallet_out_'.$object_alias, $wallet->id));
    }                        

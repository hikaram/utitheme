			...
			<div class="row mt15">
				<div class="col-md-2">
					...
					*/?>
					...
					<? else : ?>
						<img src="<?=Yii::app()->theme->baseUrl.'/public/office/wallets/default/no-pay-image.png'?>" alt="<?=$this->pageTitle;?>" />
					<? endif; ?>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<div class="col-md-12">
							<?=$form->labelEx($modelFinance, 'amount', array('class' => 'col-sm-3 control-label', 'style' => 'margin-top: -9px;'))?>
							<div class="input-group input-large">
								...
								<? if($this->modelFinance->currency_alias != "") : ?>
									<span class="input-group-addon"><?=$this->modelFinance->getModelCurrency()->abbreviation?></span>
								<? endif; ?>

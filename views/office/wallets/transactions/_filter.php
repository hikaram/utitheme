	...
	<div class="panel-body form" style="display: none;"  id="content_filter">
		...
		<div class="form-body">
					...
					<div class="col-md-6">
						...
						<div class="row" style="margin: 0 15px 0;">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<div class="input-group input-large date date-picker" data-date-format="dd.mm.yyyy" >
										<?php echo $form->textField($filtermodel,'date_closed', array('class'=>'form-control', 'name'=>'filter[date][date_closed]', 'readonly' => 'readonly', 'style' => 'background: #fff;'))?>
										<span class="input-group-btn">
											<button class="btn default" onclick="return false;">
												<i class="fa fa-calendar"></i>
											</button>
			...
			<div class="form-actions">
				...
				<?php echo CHtml::button(Yii::t('app', 'Сбросить'), array('name'=>'btn_cancel', 'class' => 'btn default', 'onClick' => 'location.href="' . substr($this->createUrl('/admin/finance/transactions/index'), 0, strpos($this->createUrl('/admin/finance/transactions/index'), '/subsession/')) . '"')); ?>
			</div>
			<?php $this->endWidget(); ?>
		</div>
	</div>

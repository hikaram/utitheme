...
<div class="note note-success">
	...
	<p>
		<?=Yii::t('app', 'Если передаресация не произошлa, перейдите')?> <?=CHtml::link(Yii::t('app', 'по этой ссылке'), Yii::app()->urlManager->createUrl('/office/wallets/manage/wallets'))?>.
	</p>
</div>
...
function timekj(i){
	...
	if (i == 0)
	{
		location.href = "<?=Yii::app()->urlManager->createUrl('/office/wallets/manage/wallets')?>";
	} 
	else
	{
		i = i - 1;

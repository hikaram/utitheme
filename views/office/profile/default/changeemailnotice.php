...
<div class="portlet box green">
	<div class="portlet-title">
		<h3 class="caption">
			...
			<?= Yii::t('app', 'Подтверждение нового Email-адреса') ?></a>
		</h3>
	</div>
	<div class="portlet-body form form-horizontal">
		<div class=" form-body">
			<div class="note note-warning">
				...
				<p>
					<?=Yii::t('app', 'На Ваш новый Email было отправлено письмо с дальнейшими инструкциями для подтверждения нового адреса')?>
				</p>
			</div>
		</div>

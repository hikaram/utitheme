                ...
                <div class="col-md-7 col-sm-7">
                    <div class="form">
                        ...
                        <div class="form-group">
                         <label class="col-lg-4 control-label"><?=Yii::t('app', 'Введите финансовый пароль')?>:</label>
                         <div class="col-lg-8">
                 ...
                 <div class="form-group">
                     <label class="col-lg-4 control-label"><?=Yii::t('app', 'Подтвердите финансовый пароль')?>:</label>
                     <div class="col-lg-8">

function changePageSize()
{
    ...
    location.href=app.createAbsoluteUrl('admin/content/contents/index/unit/' + value);    
}
...
$(function(){
    ...
    $('#filterform').on('submit', function(e){
        ...
        $.ajax({
            url	: app.createAbsoluteUrl('admin/content/Ajaxdefault/saveFilter'),
            type : 'POST',
            error	: function ()
            {
            ...
            {
                location.href = '/' + app.langUri + '/admin/content/contents/index/subsession/' + data.subsession;
            },
            data	    : $('form#filterform').serialize() + '&YII_CSRF_TOKEN='+app.csrfToken+'&alias=content_default_index',
            async		: false,
            cache		: false
        });
    }); 	

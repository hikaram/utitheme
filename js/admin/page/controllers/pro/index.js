function changePageSize()
{
    ...
    location.href=app.createAbsoluteUrl('admin/page/pro/index/unit/' + value);    
}
...
$(function(){
    ...
    $('#filterform').on('submit', function(e){
        ...
        $.ajax({
            url	: app.createAbsoluteUrl('admin/page/Ajaxpro/saveFilter'),
            type : 'POST',
            error	: function ()
            {
            ...
            {
                location.href = '/' + app.langUri + '/admin/page/pro/index/subsession/' + data.subsession;
            },
            data	    : $('form#filterform').serialize() + '&YII_CSRF_TOKEN='+app.csrfToken+'&alias=pagepro_default_index',
            async		: false,
            cache		: false
        });
    }); 	

...
(function($){
    ...
    $.fn.Tree=function(settings){
        settings=jQuery.extend({
            ...
            subtree:false,
            subtree_nodes:'root',
            subtree_markup:'<div class="tnm-subtree"><div class="tnmst-menu"><span class="tnmst-menu-element tnm-toggle mode-subtree" action="expand" mode="subtree">' + T('Развернуть полностью') + '</span><hr style="background-color:#a3a2a2;" size="1px"><span class="tnmst-menu-element tnm-toggle mode-subtree" action="collapse" mode="subtree">' + T('Свернуть полностью') + '</span></div></div>'
    },settings);
    var mode='firstline';
    var action='collapse';
    ...
    this.each(function(){
        ...
        tree.each(function(node_index,node_obj){
            ...
            if(node.attr('children_count')>0){
                ...
                var fa=node.find('div.tnm-children .fa');
                tnm_children.addClass('tnm-toggle').attr('mode','firstline').attr('action',attribute_action);
                fa.addClass('tnm-toggle-fa').attr('mode','firstline').attr('action',attribute_action);
        ...
        tree.find('.tnm-toggle-fa').live('click',handler);
        return false;
    });
    return this;
    };
